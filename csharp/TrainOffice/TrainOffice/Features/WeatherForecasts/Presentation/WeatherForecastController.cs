...
namespace TrainOffice.Features.WeatherForecasts.Presentation
{
    ...
    {
        private readonly IGetWeatherForecast _weatherForecastApplication;

        public WeatherForecastController(IGetWeatherForecast weatherForecastApplication)
        {
        ...
        {
            var forecast = await _weatherForecastApplication.GetWeatherForecastAsync();
